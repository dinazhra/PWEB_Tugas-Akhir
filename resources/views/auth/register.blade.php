...
<div class="min-h-screen flex bg-[#F2F7F2]">
        ...
        <div class="relative z-10 flex flex-col justify-between px-16 py-14 text-white w-full">
            ...
            <div class="flex items-center gap-4">
                <div class="w-14 h-14 rounded-2xl bg-[#8bc34a] flex items-center justify-center shadow-lg flex-shrink-0">
                    <svg viewBox="0 0 28 28" fill="none" class="w-8 h-8">
            ...
            <div>
                ...
                <h2 class="text-6xl font-extrabold leading-[1.05] tracking-tight">
                    Bergabung<br>Bersama<br>
                    <span class="text-[#8bc34a]">AgroMart</span>
                </h2>
                <p class="mt-6 text-[#a8d5ab] text-base leading-7 max-w-md">
                    Daftarkan akun Anda dan mulai belanja pupuk berkualitas untuk kebutuhan pertanian modern.
                </p>
            </div>
    ...
    {{-- RIGHT SIDE --}}
    <div class="w-full lg:w-[45%] flex justify-center items-center px-6 py-10">
        <div class="w-full max-w-[420px]">
            ...
            <div class="bg-white border border-[#E0EDE1] shadow-[0_8px_40px_rgba(0,0,0,0.07)] rounded-[28px] p-9">
                ...
                <div class="text-center mb-7">
                    ...
                    <h2 class="text-3xl font-extrabold text-[#17361F] tracking-tight">Buat Akun</h2>
                    <p class="text-gray-400 text-sm mt-2 leading-6">Daftarkan akun AgroMart Anda untuk mulai berbelanja.</p>
                </div>
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="mb-4">
                        <label class="block mb-2 text-sm font-semibold text-[#17361F]">Nama Lengkap</label>
                        <div class="relative">
                            ...
                            <input type="text" name="name" value="{{ old('name') }}" required autofocus placeholder="Nama lengkap"
                                class="w-full pl-11 pr-4 py-3 rounded-xl border border-gray-200 bg-[#FAFBFA] text-sm text-gray-800 placeholder-gray-400 focus:ring-4 focus:ring-green-100 focus:border-[#2F6B45] outline-none transition">
                        </div>
                        <x-input-error :messages="$errors->get('name')" class="mt-2" />
                    </div>

                    <div class="mb-4">
                        <label class="block mb-2 text-sm font-semibold text-[#17361F]">Username</label>
                        <div class="relative">
                            <span class="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
                            ...
                            <input type="text" name="username" value="{{ old('username') }}" required placeholder="Username unik"
                                class="w-full pl-11 pr-4 py-3 rounded-xl border border-gray-200 bg-[#FAFBFA] text-sm text-gray-800 placeholder-gray-400 focus:ring-4 focus:ring-green-100 focus:border-[#2F6B45] outline-none transition">
                        </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="relative">
                            ...
                            <input id="password" type="password" name="password" required autocomplete="new-password" placeholder="Minimal 8 karakter"
                                class="w-full pl-11 pr-12 py-3 rounded-xl border border-gray-200 bg-[#FAFBFA] text-sm text-gray-800 placeholder-gray-400 focus:ring-4 focus:ring-green-100 focus:border-[#2F6B45] outline-none transition">
                            <button type="button" onclick="togglePassword()" class="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 hover:text-[#2F6B45] transition">
                                <svg id="eye-open" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" style="width:18px;height:18px;display:block">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.964-7.178z"/>
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                </svg>
                                <svg id="eye-close" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" style="width:18px;height:18px;display:none">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M3 3l18 18"/>
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M10.477 10.488a3 3 0 004.242 4.242"/>
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M9.88 5.09A9.953 9.953 0 0112 4.5c4.638 0 8.573 3.007 9.963 7.178a1.01 1.01 0 010 .644 10.05 10.05 0 01-4.043 5.116M6.228 6.228A10.05 10.05 0 002.037 11.68a1.01 1.01 0 000 .644C3.423 16.493 7.36 19.5 12 19.5a9.953 9.953 0 005.272-1.5"/>
                                </svg>
                            </button>
                        </div>
                    ...
                    <div class="mb-6">
                        <label class="block mb-2 text-sm font-semibold text-[#17361F]">Konfirmasi Password</label>
                        <div class="relative">
                            <span class="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z"/>
                            ...
                            <input id="confirm_password" type="password" name="password_confirmation" required placeholder="Ulangi password"
                                class="w-full pl-11 pr-12 py-3 rounded-xl border border-gray-200 bg-[#FAFBFA] text-sm text-gray-800 placeholder-gray-400 focus:ring-4 focus:ring-green-100 focus:border-[#2F6B45] outline-none transition">
                            <button type="button" onclick="toggleConfirmPassword()" class="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 hover:text-[#2F6B45] transition">
                                <svg id="confirm-eye-open" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" style="width:18px;height:18px;display:block">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.964-7.178z"/>
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                </svg>
                                <svg id="confirm-eye-close" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" style="width:18px;height:18px;display:none">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M3 3l18 18"/>
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M10.477 10.488a3 3 0 004.242 4.242"/>
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M9.88 5.09A9.953 9.953 0 0112 4.5c4.638 0 8.573 3.007 9.963 7.178a1.01 1.01 0 010 .644 10.05 10.05 0 01-4.043 5.116M6.228 6.228A10.05 10.05 0 002.037 11.68a1.01 1.01 0 000 .644C3.423 16.493 7.36 19.5 12 19.5a9.953 9.953 0 005.272-1.5"/>
                                </svg>
                    ...
                    <p class="text-center text-gray-400 text-sm mt-6">
                        Sudah punya akun?
                        <a href="{{ route('login') }}" class="text-[#2F6B45] font-bold hover:underline">Login sekarang</a>
                    </p>
...
<script>
// LOGIKA BENAR:
// - eye-open (mata normal) tampil saat password TERSEMBUNYI (titik-titik)
// - eye-close (mata dicoret) tampil saat password TERLIHAT (teks)
// Klik eye-open → tampilkan password → ganti ke eye-close
// Klik eye-close → sembunyikan password → ganti ke eye-open
...
function toggleConfirmPassword() {
    ...
    const eyeClose = document.getElementById('confirm-eye-close');
    if (pw.type === 'password') {
        pw.type = 'text';
        eyeOpen.style.display  = 'block';
        eyeClose.style.display = 'none';
